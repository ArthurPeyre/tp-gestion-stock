...
| Signature | Utilité |
| --------- | ------- |
| `.toLowerCase()` | Convertie une chaîne de caractère en minuscule. |
| `.includes()` | Retourne un booléen selon si la valeur entrée en paramètre est contenue dans celle sur laquelle est appliqué la fonction. |